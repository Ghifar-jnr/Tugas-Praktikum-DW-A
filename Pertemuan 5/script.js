...
function tampilkanDaftarBuku() {
    ...
    daftarBuku.forEach((buku, index) => {
        ...
        divBuku.innerHTML = `
            ...
            <button onclick="hapusDariDaftar(${index})" style="background-color: red;">Hapus</button>
        `;
...
function tampilkanBukuFavorit() {
    ...
    bukuFavorit.forEach((buku, index) => {
        ...
        divBuku.innerHTML = `
            <p>${buku.tampilkanInfo()}</p>
            <button onclick="hapusDariFavorit(${index})" style="background-color: red;">Hapus</button>
        `;
